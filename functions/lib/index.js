...
appContent.get('/:language/offres-emploi.html', serve_content_1.default.jobsIndex);
appContent.get('/:language/offres-emploi/:id/:slug', serve_content_1.default.jobPage);
